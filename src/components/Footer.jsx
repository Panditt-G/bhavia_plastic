        ...
        <div className="container grid grid-cols-1 md:grid-cols-2 lg:grid-cols-[2fr_1fr_1.5fr_1.5fr] gap-12 lg:gap-16">
          ...
          <div className="md:col-span-2 lg:col-span-1">
            ...
            <div className="flex gap-2">
              ...
              <a href={`tel:${contact.phone}`} className="w-10 h-10 rounded-md flex items-center justify-center transition-all duration-150 opacity-80 hover:opacity-100 hover:-translate-y-[2px] bg-accent text-primary" aria-label="Call">
